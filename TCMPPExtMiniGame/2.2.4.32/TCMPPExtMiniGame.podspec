Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tcmpp/ios-sdk/beta/TCMPPExtMiniGame/2.2.4.32/TCMPPExtMiniGame_2.2.4.32.framework.zip' }
